...
subroutine USER_set_coord(Rlay, g_prime, GV, US, param_file, eqn_of_state)
  ...
  ! g_prime(:) = 0.0
  g_prime(1) = 9.80
  g_prime(2) = 0.01 ! 0.034 ! 0.01
  g_prime(3) = 0.3 * g_prime(2) ! 0.018 ! 0.3 * g_prime(2)

  Rlay(1) = 1.028106e+03 !1.0e+03 !1.028106e+03
  Rlay(2) = 1.032161e+03 ! 1.003469e+03 !1.032161e+03
  Rlay(3) = 1.035000e+03 ! 1.005306e+03 !1.035000e+03
