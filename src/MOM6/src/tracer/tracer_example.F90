...
integer, parameter :: NTR = 9 !< The number of tracers in this module.
...
#include "version_variable.h"
  ...
  do m=1,NTR
    ...
    ! CHECKED print*,'JUST a test: register ', name    
...
! Local variables
  ...
  !print*,'restart = ',restart, 'NTR = ',NTR
  !do m=1,NTR
  !   print*,'max/min = ', maxval(CS%tr(:,:,:,m)), CS%tr(4+5,4+5,1,m)
  !enddo
